// ignore_for_file: file_names, depend_on_referenced_packages, unused_local_variable, no_leading_underscores_for_local_identifiers, unrelated_type_equality_checks, use_build_context_synchronously
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                // const Spacer(flex: 3),
                                IconButton(
                                  icon: const Icon(Icons.loop, size: 30),
                                  onPressed: () async {
                                    await assetsAudioPlayer.stop();
                                    setState(() {
